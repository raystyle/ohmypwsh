---
name: rmux
description: RMUX 终端复用器（本机 D:\ohmyenv\rmux 0.10.0，Windows/pwsh）正确用法：会话/窗格管理、send-keys 目标与等待语义、capture-pane/stream-pane 输出读取、rmux claude 集成与 Claude Code 调试。涉及 rmux/tmux、分屏、驱动或调试 claude 时使用。
---
